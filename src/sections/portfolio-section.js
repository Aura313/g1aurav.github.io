...
class PortfolioSectionInner extends React.Component {
  state = {
    isDialogOpen: false,
    dialogTitle: '',
    dialogImage: ''
  ...
  portfolio = (portfolio, index) => {
    const imgUrl = "./assets/portfolio/" + portfolio.image;
    return (
      <div>
...
export const PortfolioSection = withStyles(styles)(PortfolioSectionInner);